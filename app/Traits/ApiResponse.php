...
trait ApiResponse
{
    ...
    public function failed($code = Response::HTTP_UNPROCESSABLE_ENTITY, $message = 'Failed',$source='product-service'){
    ...
    private function customException($resource, $message, $errorCode = -1,$source='product-service')
    {
        $meta   = [
            'message'   => $message,
            'errorCode' => $errorCode,
